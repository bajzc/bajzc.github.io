...
.. note::
    ...
    Arch (Manjaro) and Gentoo (livecd?) are a good start, there are good start of Linux, as it is also not easy.

    Some steps: kernel config file and grub config can be copy from or generated by the host host system as a shortcut.
