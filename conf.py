...
BLOG_AUTHOR = "bajzc"  # (translatable)
BLOG_TITLE = "Jason's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://bajzc.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://bajzc.com/"
BLOG_EMAIL = "lzecheng98@gmail.com"
BLOG_DESCRIPTION = "A technology blog that knows nothing."  # (translatable)
